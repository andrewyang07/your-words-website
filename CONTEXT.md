...
**Review Quota**:
The small set of items selected for one Daily Review, typically a few short items plus one chapter chunk.
_Avoid_: Due queue, inbox zero, all pending reviews

**Continue Review**:
An optional extra review round after the user completes the daily quota.
...
**Review Stage**:
The memorization state of a verse inside the Daily Review flow: New, Learning, Reviewing, or Mastered.
